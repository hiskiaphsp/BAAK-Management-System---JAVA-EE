...
Route::get('/user-data', [AuthController::class, 'validateToken']);
...
route::get('/BAAK/EditUsers/{id}',[PageController::class,'EditUserForm'])->name('Edit_User');
...
route::get('/BAAK/Surat/approve/{id}',[SuratAdminController::class,'Approve'])->name('Approve_Surat');
