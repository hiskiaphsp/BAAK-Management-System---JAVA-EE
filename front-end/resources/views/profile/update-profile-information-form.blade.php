<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="nim" type="text" class="mt-1 block w-full" wire:model="state.nim" required autocomplete="nim" />
            <x-input-error for="nim" class="mt-2" />
        </div>
        <!-- Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="ktp" value="{{ __('KTP') }}" />
            <x-input id="ktp" type="text" class="mt-1 block w-full" wire:model="state.ktp" required autocomplete="ktp" />
            <x-input-error for="ktp" class="mt-2" />
        </div>
        <!-- Name -->
        <div class="col-span-6 sm:col-span-4">
